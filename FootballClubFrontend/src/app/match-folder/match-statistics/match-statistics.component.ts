      ...
      this.matchService.getMatchStatistics(this.matchId).subscribe(
        response => {
          ...
          this.statisticsForm = this.fb.group({
            ...
            passes: [this.statistics?.generalMatchStatistics.passes,[Validators.required]],
          ...
          this.opponentStatisticsForm = this.fb.group({
            ...
            passes: [this.opponentStatistics?.generalMatchStatistics.passes,[Validators.required]],
