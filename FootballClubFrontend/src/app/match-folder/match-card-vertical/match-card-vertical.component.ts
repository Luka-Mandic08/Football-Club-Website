...
@Component({
  selector: 'app-match-card-vertical',
  templateUrl: './match-card-vertical.component.html',
  styleUrls: ['./match-card-vertical.component.css']
})
export class MatchCardVerticalComponent {
